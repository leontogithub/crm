...
/*			alert($("#create-owner").val())
	...
	function showClueList(pageNo,pageSize){
		$.ajax({
			...
			type : "post",
			dataType : "json",
			success : function (data){/*5750886f3b92439a89187241cf0df784*/
				var html = "";
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-appellation">
								  <option></option>
									<a:forEach items="${appellation}" var="a">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-state">
								  <option></option>
									<a:forEach items="${clueState}" var="c">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody id="searchClueList">
						<%--<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=5750886f3b92439a89187241cf0df784';">武松</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
